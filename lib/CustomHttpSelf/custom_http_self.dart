...
class CustomHttpSelf {
  ...
  selfCheckInCheckOut(
      ...
      String Note) async {
    print(
        "$UserId---$AttendanceDate---$AttendanceTime---$RefCardNo---$Location---$lng---$Empcode---$DutyDate"
    ...
    try {
      print(
          "Check ------------------------------------- Status----------------------------------");
      var data = await http
          .post(Uri.parse("${BASEURL}/${SelfCheckInCheckOut}"),
              headers: {
        ...
        print(
            "ssssssssssssssssssssssssssssssssss ${selfCheckInCheckOut["status"]}");
      });
  ...
  selfOneMonthAttendanceFunction(
    ...
    try {
      var data = await http
          .post(Uri.parse("${BASEURL}/${SelfGetMonthlyAttendanceList}"),
              headers: {
                "Content-Type": "application/json",
                "username": "jibikaapps",
                "password": "20jibika24",
        ...
        for (int i = 1; i < DateTime(yyyy, MMMM + 1, 0).day + 1; i++) {
          ...
          for (var item in monthlyAttendanceSummary) {
            ...
            if (tempday == i) {
              print(
                  "duty date:${int.parse("${item["DUTY_DATE"].substring(0, 2)}")}");
              tempobj.Status = "${item["STATUS"]}";
              tempobj.iNTIME = "${item["IN_TIME"]}" == ""
                  ? "--:--:--"
                  : "${item["IN_TIME"].substring(12, 20)}";
              tempobj.oUTTIME = "${item["OUT_TIME"]}" == ""
                  ? "--:--:--"
                  : "${item["OUT_TIME"].substring(12, 20)}";
  ...
  ///  Leave allocation --------------------------------------------------------------------------
  selfLeaveAllocation(
      String UserId, String EMPCODE, BuildContext context) async {
    dynamic selfLeaveAllocationList;
    var body = jsonEncode({"UserId": "$UserId", "EMPCODE": "$EMPCODE"});

    try {
      var data = await http
          .post(Uri.parse("${BASEURL}/${Self_Admin_Leave_Allocation}"),
              headers: {
                "Content-Type": "application/json",
                "username": "jibikaapps",
                "password": "20jibika24",
      ...
      print(
          "self Leave Allocation Catch error ============================ ${e}");
    }
  }

  ///  Self Or Admin Get Leave Early Count --------------------------------------------------------------------------
  selfAdminGetLeaveEarlyCount(
      String UserId, String EMPCODE, BuildContext context) async {
    ...
    try {
      var data = await http
          .post(
              Uri.parse(
                  "${BASEURL}/${Self_Admin_Get_Leave_Register_By_Employee}"),
              headers: {
                "Content-Type": "application/json",
                "username": "jibikaapps",
                "password": "20jibika24",
      ...
      print(
          " self Or Admin Get Leave Early Count Catch error ============================ ${e}");
    }
  }

  ///  Self Or Admin Get selfAdminAdmin Get Monthly Att SummaryCountList Count --------------------------------------------------------------------------
  selfAdminAdmin_Get_Monthly_Att_SummaryCount(
    ...
    try {
      var data = await http
          .post(
              Uri.parse(
                  "${BASEURL}/${Self_Admin_Get_Monthly_Att_Summary_By_Employee}"),
              headers: {
                "Content-Type": "application/json",
                "username": "jibikaapps",
                "password": "20jibika24",
      ...
      print(
          " self Or Admin Get selfAdminAdmin_Get_Monthly_Att_SummaryCountList Count Catch error ============================ ${e}");
    }
  }
  ...
  selfAdminAdmin_Get_Emp_New_Face_Get() async {
    ...
    try {
      var data = await http
          .post(
              Uri.parse(
                  "${BASEURL}/${Self_Admin_GetEmpNewFaceList_By_Employee}"),
              headers: {
                "Content-Type": "application/json",
                "username": "jibikaapps",
                "password": "20jibika24",
        ...
        print(
            "-----------------------------$selfAdminAdmin_Emp_New_Face_GetList");
      });
  ...
  selfAdminSaveLeaveRegister_By_Employee(
      ...
      String HALFDAY,
      String HOLIDAYFOND,
      String ATEENBONUSFLAG,
      String LEAVEREASON,
      String ADDRESSDURINGLEAVE,
      String DUTYCARRIEDOUTBY,
      String MOBILENO,
      String STAFFCATEGORYCODE,
      String USERTYPEID,
      BuildContext context) async {
    print(
      "AAAAAAAAAAAAAAAA===> ${GetStorage().read("mobile_id")}",
    );
    print(
      "AAAAAAAAAAAAAAAA===> ${GetStorage().read("IdCardNo")}",
    );
    print(
      "AAAAAAAAAAAAAAAA===> ${GetStorage().read("Empcode")}",
    );
    print(
      "AAAAAAAAAAAAAAAA= LEAVETYPECODE==> ${LEAVETYPECODE}",
    );
    print(
      "AAAAAAAAAAAAAAAA=LEAVEDAYS==> ${LEAVEDAYS}",
    );
    print(
      "AAAAAAAAAAAAAAAA==FROMDATE=> ${FROMDATE}",
    );
    print(
      "AAAAAAAAAAAAAAAA=TODATE==> ${TODATE}",
    );
    print(
      "AAAAAAAAAAAAAAAA=APPLYDATE==> ${APPLYDATE}",
    );
    print(
      "AAAAAAAAAAAAAAAA=HALFDAY==> ${HALFDAY}",
    );
    print(
      "AAAAAAAAAAAAAAAA==HOLIDAYFOND=> ${HOLIDAYFOND}",
    );
    print(
      "AAAAAAAAAAAAAAAA==ATEENBONUSFLAG=> ${ATEENBONUSFLAG}",
    );
    print(
      "AAAAAAAAAAAAAAAA==LEAVEREASON=> ${LEAVEREASON}",
    );
    print(
      "AAAAAAAAAAAAAAAA=ADDRESSDURINGLEAVE==> ${ADDRESSDURINGLEAVE}",
    );
    print(
      "AAAAAAAAAAAAAAAA==DUTYCARRIEDOUTBY=> ${DUTYCARRIEDOUTBY}",
    );
    print(
      "AAAAAAAAAAAAAAAA=MOBILENO==> ${MOBILENO}",
    );
    print(
      "AAAAAAAAAAAAAAAA=STAFFCATEGORYCODE==> ${STAFFCATEGORYCODE}",
    );
    print(
      "AAAAAAAAAAAAAAAA=USERTYPEID==> ${USERTYPEID}",
    );
    ...
    try {
      var data = await http
          .post(
              Uri.parse(
                  "${BASEURL}/${Self_Admin_SaveLeaveRegister_By_Employee}"),
              headers: {
                "Content-Type": "application/json",
                "username": "jibikaapps",
                "password": "20jibika24",
        ...
        print(
            " sydgf gsudf usd fsdf gusyd=====================>   ${SaveLeaveRegister}");
        ElegantNotification(
      ...
      print(
          " self Or Admin Save Leave Registert Catch error ============================ ${e}");
    }
  }
  ...
  createConveyance_By_Employee(
    ...
    try {
      var data = await http
          .post(Uri.parse("${BASEURL}/${SaveConveyance}"),
              headers: {
                "Content-Type": "application/json",
                "username": "jibikaapps",
                "password": "20jibika24",
        ...
        SaveLeaveRegister = jsonDecode(response.body);
        GetStorage()
            .write("for_end_conveyance_code", "${SaveLeaveRegister["code"]}");
      });
      return SaveLeaveRegister;
    } catch (e) {
  ...
  ///  Create Conveyance --------------------------------------------------------------------------
  showConveyanceSelfHttp(String AttendanceDate, String AttendanceTime,
      BuildContext context) async {
    ...
    try {
      var data = await http
          .post(Uri.parse("${BASEURL}/${showConveyanceLisByEmployee}"),
              headers: {
                "Content-Type": "application/json",
                "username": "jibikaapps",
                "password": "20jibika24",
