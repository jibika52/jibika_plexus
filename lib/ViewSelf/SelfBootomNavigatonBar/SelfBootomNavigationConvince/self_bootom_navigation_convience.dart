...
class SelfBootomNavigationConvienceScreen extends StatefulWidget {
  ...
  @override
  State<SelfBootomNavigationConvienceScreen> createState() =>
      _SelfBootomNavigationConvienceScreenState();
}

class _SelfBootomNavigationConvienceScreenState
    extends State<SelfBootomNavigationConvienceScreen> {
  @override
  void initState() {
                                ...
                                ListView.builder(
                                  ...
                                  itemBuilder: (context, index) => Container(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color:
                                            CustomAppbarColor.withOpacity(0.3),
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ColorCustomText(
                                                    ...
                                                    text:
                                                        "${value.showConveyancelist[index]["DutyDate"]}",
                                                    letterSpacing: 0.3),
                                                ColorCustomText(
                                                    fontSize: font13header,
                                                    textColor:
                                                    ...
                                                    fontWeight: FontWeight.w600,
                                                    text:
                                                        "BDT : ${value.showConveyancelist[index]["TotalAmount"]}",
                                                    letterSpacing: 0.3),
                                              ],
                                            ),
                                          ),
                                          value.showConveyancelist[index]
                                                      ["dailyConveyancels"] ==
                                                  null
                                              ? Center(
                                                  child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          ColorCustomText(
                                                                            ...
                                                                            fontWeight:
                                                                                FontWeight.w400,
                                                                            text:
                                                                                "${value.showConveyancelist[index]["dailyConveyancels"][dailyConveyancels]["Location"] ?? "${value.showConveyancelist[index]["dailyConveyancels"][dailyConveyancels]["StreetName"]}"}",
                                                                            letterSpacing:
                                                                                0.2,
                                                                            textColor:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          ColorCustomText(
                                                                            ...
                                                                            fontWeight:
                                                                                FontWeight.w400,
                                                                            text:
                                                                                "${value.showConveyancelist[index]["dailyConveyancels"][dailyConveyancels]["Location"] ?? "${value.showConveyancelist[index]["dailyConveyancels"][dailyConveyancels]["tStreetName"]}"}",
                                                                            letterSpacing:
                                                                                0.2,
                                                                            textColor:
                                                                                Main_Theme_textColor.withOpacity(0.7),
                                                                  ...
                                                                  ColorCustomText(
                                                                      ...
                                                                      fontWeight:
                                                                          FontWeight
                                                                              .w400,
                                                                      text:
                                                                          "${value.showConveyancelist[index]["dailyConveyancels"][dailyConveyancels]["Distance"] ?? "coming soon"}",
                                                                      letterSpacing:
                                                                          0.2,
                                                                      textColor:
                                                                          Main_Theme_textColor),
                                                                  ColorCustomText(
                                                                      ...
                                                                      fontWeight:
                                                                          FontWeight
                                                                              .w400,
                                                                      text:
                                                                          "Total Amount : ${value.showConveyancelist[index]["dailyConveyancels"][dailyConveyancels]["Amount"] ?? "0"}",
                                                                      letterSpacing:
                                                                          0.2,
                                                                      textColor:
                                                                          Main_Theme_textColor),
                                                                  ...
                                                                  ColorCustomText(
                                                                      ...
                                                                      fontWeight:
                                                                          FontWeight
                                                                              .w400,
                                                                      text:
                                                                          "Duration : ${value.showConveyancelist[index]["dailyConveyancels"][dailyConveyancels]["Hour"] ?? "0"} ${value.showConveyancelist[index]["dailyConveyancels"][dailyConveyancels]["Minute"] ?? "0"}",
                                                                      letterSpacing:
                                                                          0.2,
                                                                      textColor:
                                                                          Main_Theme_textColor),
                                                              ...
                                                              child: ColorCustomText(
                                                                  ...
                                                                  fontWeight:
                                                                      FontWeight
                                                                          .w400,
                                                                  text:
                                                                      "Purpose: ${value.showConveyancelist[index]["dailyConveyancels"][dailyConveyancels]["Remarks"] ?? "No Comments"}",
                                                                  letterSpacing:
                                                                      0.2,
                                                                  textColor:
                                                                      Main_Theme_textColor),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => CreateConveyanceScreen(),
              ));
        },
        child: Icon(
          Icons.add,
