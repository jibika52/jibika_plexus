...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    dynamic getProfile =
        Provider.of<OnboardingEmployeeController>(context).GetEmployeeByIdList;
    List<SelfProfileInformationCard> SelfProfileInformationCardlist = [
      SelfProfileInformationCard(
        ...
        text1: "Employee Id",
        text2: widget.areYouFromEmployee == "user"
            ? "87"
            : "${getProfile["ID_CARD_NO"]}",
      ),
      SelfProfileInformationCard(
      ...
      SelfProfileInformationCard(
        ...
        text2: widget.areYouFromEmployee == "user"
            ? "87"
            : "${getProfile["EMPLOYEE_NAME_ENGLISH"]}",
      ),
      SelfProfileInformationCard(
      ...
      SelfProfileInformationCard(
        ...
        text2: widget.areYouFromEmployee == "user"
            ? "87"
            : "${getProfile["FATHER_NAME_ENGLISH"]}",
      ),
      SelfProfileInformationCard(
      ...
      SelfProfileInformationCard(
        ...
        text2: widget.areYouFromEmployee == "user"
            ? "87"
            : "${getProfile["PRESENT_ADDRESS_ENGLISH"] ?? ""}",
      ),
      SelfProfileInformationCard(
        image: "Assets/Employee_Profile_Icon/address.png",
        ...
        text2: widget.areYouFromEmployee == "user"
            ? "87"
            : "${getProfile["PERMANENT_ADDRESS_ENGLISH"] ?? ""}",
      ),
      SelfProfileInformationCard(
    ...
    List<SelfProfileInformationCard> SelfOfficialInformationCardlist = [
      ...
      SelfProfileInformationCard(
        ...
        text2: widget.areYouFromEmployee == "user"
            ? "87"
            : "${getProfile["DESIGNATION_ENGLISH"]}",
      ),
      SelfProfileInformationCard(
        image: "Assets/DashBoardIcons/personalcard.png",
        text1: "Section",
      ...
      SelfProfileInformationCard(
        ...
        text2: widget.areYouFromEmployee == "user"
            ? "87"
            : "${getProfile["STAFF_CATEGORY_ENGLISH"]}",
      ),
      SelfProfileInformationCard(
        image: "Assets/DashBoardIcons/personalcard.png",
        text1: "Work Station",
        text2: widget.areYouFromEmployee == "user"
            ? "87"
            : "${getProfile["WORK_STATION_ENGLISH"]}",
      ),
      SelfProfileInformationCard(
        image: "Assets/DashBoardIcons/personalcard.png",
        text1: "Joining Date",
      ...
      SelfProfileInformationCard(
        ...
        text2: widget.areYouFromEmployee == "user"
            ? "87"
            : "${getProfile["ROSTER_TYPE_ENGLISH"]}",
      ),
      SelfProfileInformationCard(
        image: "Assets/DashBoardIcons/personalcard.png",
        text1: "Shift Plan",
      ...
      SelfProfileInformationCard(
        ...
        text2: widget.areYouFromEmployee == "user"
            ? "87"
            : "${getProfile["ROSTER_GROUP_ENGLISH"]}",
      ),
      SelfProfileInformationCard(
        image: "Assets/DashBoardIcons/personalcard.png",
    ...
    List<SelfProfileInformationCard> SelfReferrerInformationCardlist = [
      SelfProfileInformationCard(
        ...
        text2: widget.areYouFromEmployee == "user"
            ? "87"
            : "${getProfile["REF_PERSON_NAME_ENGLISH"]}",
      ),
      SelfProfileInformationCard(
        image: "Assets/DashBoardIcons/personalcard.png",
    ...
    return Scaffold(
      appBar: PreferredSize(
          ...
          child: CustomDefaultAppBar(
              onTap: () => Navigator.pop(context), text: "Profile")),
      ...
      body: Stack(
        children: [
              ...
              child: Column(
                children: [
                  ...
                  customMainEmployeeProfile(
                    ...
                    image: widget.areYouFromEmployee == "user"
                        ? "87"
                        : "${getProfile["EMP_PHOTO_PATH"]}",
                    employeeCode: widget.areYouFromEmployee == "user"
                        ? "87"
                        : "${getProfile["EMPCODE"]}",
                    employeeName: widget.areYouFromEmployee == "user"
                        ? "87"
                        : "${getProfile["EMPLOYEE_NAME_ENGLISH"]}",
                    employeeDesignation: widget.areYouFromEmployee == "user"
                        ? "87"
                        : "${getProfile["DESIGNATION_ENGLISH"]}",
                    employeeDepartment: widget.areYouFromEmployee == "user"
                        ? "87"
                        : "${getProfile["DEPARTMENT_ENGLISH"] ?? ""}",
                    birthday: widget.areYouFromEmployee == "user"
                        ? "87"
                        ...
                        return InkWell(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                                ...
                                border: Border(
                                    bottom:
                                        BorderSide(color: CustomButtonColor))),
                            margin: EdgeInsets.only(bottom: 7),
                            child: Column(
                              children: [
                                Container(
                                    ...
                                    ? AnimatedContainer(
                                        ...
                                        child: Container(
                                          ...
                                          itemCount: selectedindex == 0
                                              ? SelfProfileInformationCardlist
                                                  .length
                                              : selectedindex == 1
                                                  ? SelfOfficialInformationCardlist
                                                      .length
                                                  : selectedindex == 2
                                                      ? SelfSalaryInformationCardlist
                                                          .length
                                                      : SelfReferrerInformationCardlist
                                                          .length,
                                          itemBuilder: (context, index) {
                                            return selectedindex == 0
                                                              ...
                                                              children: [
                                                                Text(
                                                                  SelfProfileInformationCardlist[
                                                                          index]
                                                                      .text1,
                                                                  style: customHeadingTextStyle(
                                                                      Main_Theme_textColor
                                                                          .withOpacity(
                                                                              0.7)),
                                                                ),
                                                                SelfProfileInformationCardlist[index]
                                                                            .text2 ==
                                                                        ""
                                                                    ? Container()
                                                                    : Text(
                                                ...
                                                : selectedindex == 1
                                                    ? SelfProfileImageNameSubName(
                                                        image:
                                                            "${SelfOfficialInformationCardlist[index].image}",
                                                        text1:
                                                            "${SelfOfficialInformationCardlist[index].text1}",
                                                        text2:
                                                            "${SelfOfficialInformationCardlist[index].text2}",
                                                      )
                                                    : selectedindex == 2
                                                        ? SelfProfileImageNameSubName(
                                                            image:
                                                                "${SelfSalaryInformationCardlist[index].image}",
                                                            text1:
                                                                "${SelfSalaryInformationCardlist[index].text1}",
                                                            text2:
                                                                "${SelfSalaryInformationCardlist[index].text2}",
                                                          )
                                                        : SelfProfileImageNameSubName(
                                                            image:
                                                                "${SelfReferrerInformationCardlist[index].image}",
                                                            text1:
                                                                "${SelfReferrerInformationCardlist[index].text1}",
                                                            text2:
                                                                "${SelfReferrerInformationCardlist[index].text2}",
                                                          );
                                          },
                                        )),
                                      )
          ...
          Positioned(
              bottom: 0,
              child: widget.areYouFromEmployee == "user"
                  ? Container(
                      height: 1,
                      width: double.infinity,
                    )
                                  ...
                                  children: [
                                    CircleAvatar(
                                      ...
                                      backgroundColor: selected
                                                  .selectedEmployeeforGetProfile ==
                                              index
                                          ? presentsent_color.withOpacity(0.7)
                                          : leave_color.withOpacity(0.7),
                                      child: CircleAvatar(
                                        radius:
                                            selected.selectedEmployeeforGetProfile ==
                                                    index
                                                ? 42
                                                : 44,
