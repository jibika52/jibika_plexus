...
class _SelfBootomNavigationLeaveState extends State<SelfBootomNavigationLeave> {
  ...
  void initState() {
    Provider.of<SelfDashboardController>(context, listen: false)
        .selfLeaveAllocationProvider("${GetStorage().read("mobile_id")}",
            "${GetStorage().read("Empcode")}", context);
    Provider.of<SelfDashboardController>(context, listen: false)
                  ...
                  : Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            height: apps_div_margin + 2,
                          ),
                          Container(
                            height: 60,
                            width: double.infinity,
                            child: ListView.builder(
                              itemCount: leave_status == null
                                  ? 0
                                  : leave_status.length,
                              ...
                              itemBuilder: (context, index) => InkWell(
                                onTap: () {
                                  setState(() {
                                    selest_leave = index;
                                    get_status =
                                        leave_status[index]["LeaveTypeCode"];
                                  });
                                },
                                child: Container(
                                  decoration: BoxDecoration(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ColorCustomText(
                                          fontSize:
                                              selest_leave == index ? 18 : 16,
                                          fontWeight: selest_leave == index
                                              ? FontWeight.w600
                                              : FontWeight.w500,
                                          text:
                                              "${leave_status[index]["LeaveAbbre"]}",
                                          letterSpacing: 0.3,
                                          textColor: selest_leave == index
                                              ? Main_Theme_WhiteCollor
                                              : Main_Theme_textColor),
                                      ColorCustomText(
                                          fontSize:
                                              selest_leave == index ? 16 : 14,
                                          fontWeight: selest_leave == index
                                              ? FontWeight.w500
                                              : FontWeight.w400,
                                          text:
                                              "${leave_status[index]["BalanceDays"]}",
                                          letterSpacing: 0.3,
                                          textColor: selest_leave == index
                                              ? Main_Theme_WhiteCollor
                                              : Main_Theme_textColor),
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        color:
                                            presentsent_color.withOpacity(0.4)),
                                    // color: Colors.blue,
                                  ),
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
                              ...
                              child: CustomButton(
                                  onTap: () {
                                    if (totalDate.isNegative) {
                                      customNotification(
                                          context,
                                          "Your formDate must less from to Date",
                                          "Please try again");
                                      selectedformDatee =
                                      ...
                                      Provider.of<SelfDashboardController>(
                                              context,
                                              listen: false)
                                  ...
                                  text: "Apply",
                                  fontWeight: FontWeight.w600,
                                  button_text_fontSize: fontTitle,
                                  button_height: 40,
  ...
  DayCalculation() {
    ...
    print(
        "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb ${diff.inDays}");
//output (in days): 1198
    setState(() {
      totalDate = int.parse("${diff.inDays}") + 1;
      if (totalDate.isNegative) {
        //  customNotification(context, "Your formDate must less from to Date", "Please try again");
        quickAlertsuccess(context, "Warning for you",
            "Your formDate must less from toDate", 2);
        selectedformDatee =
            DateFormat('dd-MMM-yyyy').format(DateTime.now()).toString();
        selectedtoDatee =
            DateFormat('dd-MMM-yyyy').format(DateTime.now()).toString();
