            ...
            Container(
                ...
                //  SelfProfileSummaryPart(),
                  ...
                  customMainEmployeeProfile(
                    image: "${selfORAdminShortInformationdata["EmpImage"]??""}",
                    employeeCode: "${selfORAdminShortInformationdata["IdCardNo"]??""}",
                    employeeName: "${selfORAdminShortInformationdata["EmployeeNameEnglish"]??""}",
                     employeeDesignation:"${selfORAdminShortInformationdata["Designation"]??""}",
                    employeeDepartment: "${selfORAdminShortInformationdata["Department"]??""}",
                    birthday: "${selfORAdminShortInformationdata["JoiningDate"]??""}",
                    is_need_edit_button_on_short_profile: "false" ,
                    is_need_qr_code: true,
                    onTap: () {
