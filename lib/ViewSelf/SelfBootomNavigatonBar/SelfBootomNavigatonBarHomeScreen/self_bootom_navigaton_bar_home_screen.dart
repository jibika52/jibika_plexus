...
class SelfBootomNavigatonBarHomeScreen extends StatefulWidget {
  ...
  @override
  State<SelfBootomNavigatonBarHomeScreen> createState() =>
      _SelfBootomNavigatonBarHomeScreenState();
}

class _SelfBootomNavigatonBarHomeScreenState
    extends State<SelfBootomNavigatonBarHomeScreen> {
  ...
  void dispose() {
    print(
        "ddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx");
    timer?.cancel();
    timer2?.cancel();
    timer?.cancel();
    timer2?.cancel();
                ...
                children: [
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        CustomText(
                                            ...
                                            text: "Today Presence  ",
                                            letterSpacing: 0.3),
                                        // ColorCustomText(fontSize: font12, fontWeight: FontWeight.w400, text: "${DateTime.now().hour}${DateTime.now().minute}${DateTime.now().second}", letterSpacing: 0.3, textColor: Main_Theme_textColor.withOpacity(0.5),),
                                        //      ColorCustomText(fontSize: font12, fontWeight: FontWeight.w400, text: DateTime.now().second>9? "${DateTime.now().hour}${DateTime.now().minute}${DateTime.now().second}": "${DateTime.now().hour}${DateTime.now().minute}0${DateTime.now().second}", letterSpacing: 0.3, textColor: Main_Theme_textColor.withOpacity(0.5),),
                                        Row(
                                          mainAxisAlignment:
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            ColorCustomText(
                                              fontSize: font11,
                                              fontWeight: FontWeight.w400,
                                              text: "${selfOneMonthAttendanceList}" ==
                                                      "[]"
                                                  ? "Late :"
                                                  : "Late :${selfOneMonthAttendanceList[DateTime.now().day - 1].lATE ?? ""}",
                                              letterSpacing: 0.3,
                                              textColor: Main_Theme_textColor
                                                  .withOpacity(0.5),
                                            ),
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Image.asset(
                                              "Assets/SelfIcon/working_duration.png",
                                              height: 18,
                                              width: 18,
                                              fit: BoxFit.fill,
                                              color: Colors.grey,
                                            ...
                                            ColorCustomText(
                                              ...
                                              text: "${selfOneMonthAttendanceList}" ==
                                                      "[]"
                                                  ? "Duration : "
                                                  : "Duration : ${selfOneMonthAttendanceList[DateTime.now().day - 1].aCTUALWORKDURATION ?? ""}",
                                              letterSpacing: 0.3,
                                              textColor: Main_Theme_textColor
                                                  .withOpacity(0.5),
                                            ),
                                ...
                                GestureDetector(
                                  onLongPress: () => setState(() {
                                    timer = Timer.periodic(
                                        Duration(microseconds: 1), (timer) {
                                      setState(() {
                                        if (increase_punch_progress_bar >=
                                            0.9999999) {
                                            ...
                                            center: Column(
                                              ...
                                              children: [
                                                ...
                                                CustomImageSction2(
                                                    ...
                                                    radius: 50,
                                                    image:
                                                        "Assets/SelfIcon/test_fingerprint.png",
                                                    img_color:
                                                        Main_Theme_textColor
                                                            .withOpacity(0.5)),
                                                //     CustomText(fontSize: font12, fontWeight: FontWeight.w400, text: "${DateTime.now().hour}:${DateTime.now().minute}:${second}", letterSpacing: 0.3),
                                                // CustomText(fontSize: font10, fontWeight: FontWeight.w400, text: "5H  14M", letterSpacing: 0.3),
                                              ],
                                            ),
                                          ),
                                        ),
                                  ...
                                  children: [
                                    InkWell(
                                                ...
                                                setState(() {
                                                  ...
                                                  Animatedwidth =
                                                      MediaQuery.of(context)
                                                          ...
                                                          0.905;
                                                  _descriptionController.text =
                                                      "${selfOneMonthAttendanceList[DateTime.now().day - 1].aTTENDANCEREMARK}";
                                                });
                                              },
                                            );
                                          });
                                        ...
                                        child: CustomImageSction2(
                                          ...
                                          width: 16,
                                          radius: 0,
                                          image: "Assets/SelfIcon/comments.png",
                                          img_color:
                                          ...
                                          Expanded(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                hintText: selfOneMonthAttendanceList ==
                                                        null
                                                    ? "Processing"
                                                    : "${selfOneMonthAttendanceList[selfOneMonthAttendanceList.length - 1].aTTENDANCEREMARK}" ==
                                                            ""
                                                        ? "Remarks here"
                                                        : "${selfOneMonthAttendanceList.last.aTTENDANCEREMARK}",
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      ColorCustomText(
                                        ...
                                        fontWeight: FontWeight.w400,
                                        text:
                                            "${double.parse("$P_Count").toStringAsFixed(0)}",
                                        letterSpacing: 0.2,
                                        textColor:
                                            Main_Theme_textColor.withOpacity(
                                                0.7),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      ColorCustomText(
                                        ...
                                        fontWeight: FontWeight.w400,
                                        text:
                                            "${double.parse("$AB_Count").toStringAsFixed(0)}",
                                        letterSpacing: 0.2,
                                        textColor:
                                            Main_Theme_textColor.withOpacity(
                                                0.7),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      ColorCustomText(
                                        ...
                                        fontWeight: FontWeight.w400,
                                        text:
                                            "${double.parse("$L_Count").toStringAsFixed(0)}",
                                        letterSpacing: 0.2,
                                        textColor:
                                            Main_Theme_textColor.withOpacity(
                                                0.7),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      ColorCustomText(
                                        ...
                                        fontWeight: FontWeight.w400,
                                        text:
                                            "${double.parse("$HL_Count").toStringAsFixed(0)}",
                                        letterSpacing: 0.2,
                                        textColor:
                                            Main_Theme_textColor.withOpacity(
                                                0.7),
                  ...
                  AnimatedContainer(
                    margin: EdgeInsets.only(
                        left: 10,
                        right: 10,
                        top: is_clicked == false ? 0 : apps_div_margin),
                    //   height: 0,
                    height: animated_height,
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(7),
                                ...
                                return Container(
                                  ...
                                  child: ColorCustomText(
                                    ...
                                    text:
                                        ...
                                        //
                                        index == 0
                                            ? "${DateFormat("E").format(DateFormat("yyyy-MM-dd").parse("${DateFormat("yyyy").format(_selected_pick_month!)}-${DateFormat("MM").format(_selected_pick_month!)}-01"))}"
                                            : index == 1
                                                ? "${DateFormat("E").format(DateFormat("yyyy-MM-dd").parse("${DateFormat("yyyy").format(_selected_pick_month!)}-${DateFormat("MM").format(_selected_pick_month!)}-02"))}"
                                                : index == 2
                                                    ? "${DateFormat("E").format(DateFormat("yyyy-MM-dd").parse("${DateFormat("yyyy").format(_selected_pick_month!)}-${DateFormat("MM").format(_selected_pick_month!)}-03"))}"
                                                    : index == 3
                                                        ? "${DateFormat("E").format(DateFormat("yyyy-MM-dd").parse("${DateFormat("yyyy").format(_selected_pick_month!)}-${DateFormat("MM").format(_selected_pick_month!)}-04"))}"
                                                        : index == 4
                                                            ? "${DateFormat("E").format(DateFormat("yyyy-MM-dd").parse("${DateFormat("yyyy").format(_selected_pick_month!)}-${DateFormat("MM").format(_selected_pick_month!)}-05"))}"
                                                            : index == 5
                                                                ? "${DateFormat("E").format(DateFormat("yyyy-MM-dd").parse("${DateFormat("yyyy").format(_selected_pick_month!)}-${DateFormat("MM").format(_selected_pick_month!)}-06"))}"
                              ...
                              itemBuilder: (context, index) {
                                return CircleAvatar(
                                  ...
                                  child: Padding(
                                    ...
                                    child: CircleAvatar(
                                      radius: 26,
                                      backgroundColor: selfOneMonthAttendanceList[
                                                      index]
                                                  .Status ==
                                              ""
                                          ? Main_Theme_textColor
                                          : selfOneMonthAttendanceList[index]
                                                      .Status ==
                                                  "P"
                                              ? presentsent_color
                                              : selfOneMonthAttendanceList[index]
                                                  ...
                                                  : selfOneMonthAttendanceList[index]
                                                      ...
                                                      : selfOneMonthAttendanceList[
                                                                      index]
                                                                  .Status!
                                                                  .substring(selfOneMonthAttendanceList[index]
                                                                          .Status!
                                                                          .length -
                                                                      1) ==
                                                              "L"
                                      ...
                                      child: ColorCustomText(
                                        ...
                                        letterSpacing: 0.3,
                                        textColor: selfOneMonthAttendanceList[
                                                            index]
                                                        .Status ==
                                                    "AB" ||
                                                selfOneMonthAttendanceList[
                        ...
                        Stack(
                          children: [
                            Container(
                              ...
                              margin:
                                  EdgeInsets.only(left: 9, right: 9, bottom: 4),
                                  ...
                                  CustomText(
                                      ...
                                      text: "${selfAdminGetLeaveEarlyCountList}" ==
                                              ...
                                              "${selfAdminGetLeaveEarlyCountList}" ==
                                                  "null"
                                          ? ""
                                          : '${DateFormat("dd MMM yyyy").format(DateFormat("yyyy-MM-dd'T'HH:mm:ss").parse("${selfAdminGetLeaveEarlyCountList[0]["FromDate"] ?? 0}"))} TO ${DateFormat("dd MMM yyyy").format(DateFormat("yyyy-MM-dd'T'HH:mm:ss").parse("${selfAdminGetLeaveEarlyCountList[0]["ToDate"] ?? 0}"))}',
                                      letterSpacing: 0.4),
                                  Divider(
                                      //height: 10,
                                      ),
                                      ...
                                      MySelfLeaveStatus2(
                                          ...
                                          text2: "${selfAdminGetLeaveEarlyCountList}" ==
                                                  ...
                                                  "${selfAdminGetLeaveEarlyCountList}" ==
                                                      "null"
                                              ? ""
                                              : "${selfAdminGetLeaveEarlyCountList[0]["LeaveDays"] ?? 0}",
                                          textColor:
                                              Main_Theme_textColor.withOpacity(
                                                  0.7),
                                      ...
                                      MySelfLeaveStatus2(
                                          ...
                                          text2: "${selfAdminGetLeaveEarlyCountList}" ==
                                                  ...
                                                  "${selfAdminGetLeaveEarlyCountList}" ==
                                                      "null"
                                              ? ""
                                              : "${selfAdminGetLeaveEarlyCountList[0]["LeaveAbbreviation"] ?? ""}",
                                          textColor:
                                              Main_Theme_textColor.withOpacity(
                                                  0.7),
                                          textColor2: Main_Theme_textColor,
                                  ...
                                  child: ColorCustomText(
                                      ...
                                      text: "${selfAdminGetLeaveEarlyCountList}" ==
                                              ...
                                              "${selfAdminGetLeaveEarlyCountList}" ==
                                                  "null"
                                          ? ""
                                          : "${selfAdminGetLeaveEarlyCountList[0]["LeaveStatus"] ?? "Pending"}",
                                      letterSpacing: 0.3),
                                ))
                          ],
                        ),
