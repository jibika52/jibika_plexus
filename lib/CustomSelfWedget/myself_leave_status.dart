...
class MySelfLeaveStatus extends StatelessWidget {
   MySelfLeaveStatus({super.key,required this.text1,required this.text2,this.text3,required this.textColor ,required this.fontSize});
  String text1;
  String text2;
  String ? text3;
  Color textColor;
  ...
  Widget build(BuildContext context) {
    return    Column(
      ...
      children: [
        ...
        ColorCustomText(fontSize: fontSize, fontWeight: FontWeight.w300, text: "${text2}", letterSpacing: 0.3, textColor: textColor,),
      ],
    );
  }
}
