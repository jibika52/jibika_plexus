      ...
      children: [
        ...
        Container(
          ...
          child: MySelfLeaveStatus2(
              ...
              fontSize2: 12,
              is_row: false,
              textColor2: Main_Theme_textColor.withOpacity(0.5)),
        ),
        Spacer(),
        Container(
          height: 22,
        ...
        InkWell(
          ...
          child: Container(
            ...
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Image.asset("Assets/DashBoardIcons/map_view.png",
                    height: 24,
                    width: 24,
                    fit: BoxFit.fill,
