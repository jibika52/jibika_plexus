...
class _MyselfNewFaceScreenState extends State<MyselfNewFaceScreen> {
  ...
  void initState() {
    Provider.of<SelfDashboardController>(context, listen: false)
        .selfAdminAdmin_Get_Emp_New_FaceListProvider(context);
          ...
          children: [
            Padding(
              ...
              child: ColorCustomText(
                text: value.selfAdminAdmin_Get_Emp_New_FaceList == null
                    ? "New Date ${DateFormat('MMMM yyyy').format(DateTime.now())} Not found"
                    : "New Face - ${DateFormat('MMMM yyyy').format(DateTime.now())}",
            ...
            value.selfAdminAdmin_Get_Emp_New_FaceList == null
                ...
                : Container(
                    ...
                    child: ListView.builder(
                      itemCount: value.selfAdminAdmin_Get_Emp_New_FaceList ==
                              null
                          ? 0
                          : value.selfAdminAdmin_Get_Emp_New_FaceList.length,
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        image: value.selfAdminAdmin_Get_Emp_New_FaceList ==
                                                null
                                            ? DecorationImage(
                                                image: AssetImage(
                                                    "Assets/SelfIcon/test_attendance.png"))
                                            : DecorationImage(
                                                image: NetworkImage(
                                                    "${GetStorage().read("APPS_IMG_BASEURL")}${value.selfAdminAdmin_Get_Emp_New_FaceList[index]["EmployeeImage"] ?? ""}"),
                                                fit: BoxFit.fill,
                                              )),
                                  ),
                                ],
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Align(
                                        ...
                                        child: ColorCustomText(
                                          text:
                                              "${value.selfAdminAdmin_Get_Emp_New_FaceList[index]["EmployeeNameEnglish"] ?? ""}",
                                          fontSize: font12,
                                          fontWeight: FontWeight.w500,
                                          letterSpacing: 0.4,
                                    ...
                                    ColorCustomText(
                                        ...
                                        text:
                                            "Des.: ${value.selfAdminAdmin_Get_Emp_New_FaceList[index]["DesignationEnglish"] ?? ""}",
                                        letterSpacing: 0.2,
                                        textColor:
                                    ...
                                    ColorCustomText(
                                        ...
                                        fontWeight: FontWeight.w400,
                                        text:
                                            "Dep.: ${value.selfAdminAdmin_Get_Emp_New_FaceList[index]["DepartmentEnglish"] ?? ""}",
                                        letterSpacing: 0.2,
                                        textColor:
                                            Main_Theme_textColor.withOpacity(
                                                0.75)),
                                    ...
                                    ColorCustomText(
                                        ...
                                        fontWeight: FontWeight.w400,
                                        text:
                                            "Phone: ${value.selfAdminAdmin_Get_Emp_New_FaceList[index]["MobileNo"] ?? ""}",
                                        letterSpacing: 0.2,
                                        textColor:
                                            Main_Theme_textColor.withOpacity(
                                                0.75))
