...
class _PrivacyPolicyScreenState extends State<PrivacyPolicyScreen> {
  ...
  Widget build(BuildContext context) {
    List<Rows> prvacyPolicylist =
        Provider.of<PrivacyPolicyProvider>(context).prvacyPolicylist;
                      ...
                      child: Column(
                        ...
                        children: [
                          CustomText(
                            ...
                            text: "${value.prvacyPolicylist[index].itemName}",
                            letterSpacing: 0.32,
                ...
                children: [
                        ...
                        children: [
                          is_agree == false
                              ...
                              : CustomImageSction(
                                  ...
                                  width: 20,
                                  radius: 50,
                                  image: "Assets/Icons/done_simble.png"),
                          SizedBox(
                            width: 10,
                          ),
                          Expanded(
                              child: Text(
                            "I Agree with Privacy-Police, and Teams-Conditions",
                  ...
                  CustomButton(
                      ...
                      custom_button_collor:
                          is_agree == false ? Colors.grey : CustomButtonColor,
