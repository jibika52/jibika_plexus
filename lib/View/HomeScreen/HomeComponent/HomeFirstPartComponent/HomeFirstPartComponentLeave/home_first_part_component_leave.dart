...
class HomeFirstPartComponentLeave extends StatefulWidget {
  ...
  String? tag;
  @override
  State<HomeFirstPartComponentLeave> createState() =>
      _HomeFirstPartComponentLeaveState();
}

class _HomeFirstPartComponentLeaveState
    extends State<HomeFirstPartComponentLeave> {
  int selectedindex = 0;
        ...
        child: Column(
          children: [
            ...
            Consumer<AdminApprovalController>(
                builder: (context, value, child) => value.pendingLeaveList ==
                        null
                    ? ColorCustomText(
                        ...
                        text:
                            _selectedIndex == 0 ? "Waiting(0)" : "Approved(0)",
                        letterSpacing: 0.1)
                    : ColorCustomText(
                        textColor: _selectedIndex == 0
                            ? CheckOutColor
                        ...
                        text: _selectedIndex == 0
                            ? "Waiting(${value.pendingLeaveList.length})"
                            : "Approved(${value.pendingLeaveList.length})",
                        letterSpacing: 0.1)),
            SizedBox(
              height: 5,
            ),
            ...
            Consumer<AdminApprovalController>(
              builder: (context, value, child) => Expanded(
                flex: 2,
                child: value.pendingLeaveList == null
                    ? Center(
                    ...
                    : Container(
                        ...
                        child: Container(
                          ...
                          itemCount: value.pendingLeaveList == null
                              ? 0
                                            ...
                                            child: Padding(
                                              ...
                                              child: ClipRRect(
                                                  ...
                                                  child: CustomImageSctionNetwork(
                                                      ...
                                                      radius: 1,
                                                      image:
                                                          "${value.pendingLeaveList[index]["IMG"]}")),
                                            ),
                                          ),
                                          Expanded(
                                              flex: 4,
                                              child: Column(
                                                ...
                                                children: [
                                                  ColorCustomText(
                                                    ...
                                                    fontWeight: FontWeight.w400,
                                                    text:
                                                        "ID: ${value.pendingLeaveList[index]["ID_CARD_NO"]}",
                                                    letterSpacing: 0.3,
                                                    textColor: CustomButtonColor
                                                        .withOpacity(0.7),
                                                  ),
                                                  Text(
                                                    "${value.pendingLeaveList[index]["EMPLOYEE_NAME_ENGLISH"]}",
                                                    overflow:
                                                  ...
                                                  CustomText(
                                                    ...
                                                    text:
                                                        "${value.pendingLeaveList[index]["DESIGNATION"]}",
                                                    letterSpacing: 0.3,
                                                  ),
                                                ],
                                              )),
                                                      ...
                                                      children: [
                                                        CustomText(
                                                            ...
                                                            fontWeight:
                                                                FontWeight.w500,
                                                            text:
                                                                "${value.pendingLeaveList[index]["FROM_2_TO_DATE"]}",
                                                            letterSpacing: 0.3),
                                                        CustomText(
                                                            fontSize: font11,
                                                            fontWeight:
                                                                FontWeight.w500,
                                                            text:
                                                                "Total : ${value.pendingLeaveList[index]["LEAVE_TYPE_ENGLISH"]}-${value.pendingLeaveList[index]["LEAVE_DAYS"]} Days",
                                                            letterSpacing: 0.3),
                                                      ],
                                                    ),
                                                    SizedBox(
                                                    ...
                                                    Container(
                                                        ...
                                                        child: CustomText(
                                                          ...
                                                          fontWeight:
                                                              FontWeight.w400,
                                                          text:
                                                              "${value.pendingLeaveList[index]["REMARKS"] ?? "Missed ...\n."}",
                                                          letterSpacing: 0.2,
                                                          textAlign:
                                                              TextAlign.justify,
                                                        )),
                                                                ...
                                                                builder:
                                                                  ...
                                                                  actions: [
                                                                    ActionChip(
                                                                      ...
                                                                      onPressed:
                                                                          () {
                                                                        Provider.of<AdminApprovalController>(context, listen: false).LeaveapprovedProvider(
                                                                            "${GetStorage().read("mobile_id")}",
                                                                            "${GetStorage().read("Empcode")}",
                                                                            "${GetStorage().read("IdCardNo")}",
                                                                            "${value.pendingLeaveList[index]["TEMP_TABLE_CODE"]}",
                                                                            "${value.pendingLeaveList[index]["EMPCODE"]}",
                                                                            context);
                                                                        Navigator.pop(
                                                                            context);
                                                                      },
                                                                ...
                                                                builder:
                                                                  ...
                                                                  actions: [
                                                                    ActionChip(
                                                                      ...
                                                                      onPressed:
                                                                          () {
                                                                        Provider.of<AdminApprovalController>(context, listen: false).LeaveRejectProvider(
                                                                            "${GetStorage().read("mobile_id")}",
                                                                            "${GetStorage().read("Empcode")}",
                                                                            "${GetStorage().read("IdCardNo")}",
                                                                            "${value.pendingLeaveList[index]["TEMP_TABLE_CODE"]}",
