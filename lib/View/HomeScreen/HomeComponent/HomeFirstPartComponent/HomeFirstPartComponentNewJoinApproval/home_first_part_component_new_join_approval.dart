        ...
        child: Column(
          children: [
            ...
            Consumer<HomeProvider>(
                ...
                Center(child: Text("")):
                ColorCustomText(textColor:_selectedIndex==0?presentsent_color:absent_color,fontSize: fontSubTitle-2, fontWeight: FontWeight.w500, text: _selectedIndex==0?"Waiting(${value.ThisMonthJoinEmployeeList.length})":"Disapproved(${value.ThisMonthJoinEmployeeList.length})", letterSpacing: 0.1)),
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return InkWell(
                      onTap: () {
                        Navigator.push(context, CupertinoPageRoute(builder: (context) => EmployeeProfileScreen(currentEmployeedataIndex: value.ThisMonthJoinEmployeeList[index]),));
                      },
                      child: Container(
                        decoration: BoxDecoration(
                                ...
                                backgroundImage: AssetImage("Assets/DrawerImage/testperson.png"),
                                  ...
                                  Expanded(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ColorCustomText(fontSize: font12, fontWeight: FontWeight.w500, text: "ID: ${value.ThisMonthJoinEmployeeList[index]["EMPCODE"]}", letterSpacing: 0.3, textColor: CustomButtonColor.withOpacity(0.7),),
                                          Text("${value.ThisMonthJoinEmployeeList[index]["EMPLOYEE_NAME_ENGLISH"]}",
                                          ...
                                          CustomText(maxLines: 1,overflow: TextOverflow.ellipsis,fontSize: font12, fontWeight: FontWeight.w400, text: "${value.ThisMonthJoinEmployeeList[index]["DESIGNATION_ENGLISH"]}", letterSpacing: 0.3,  ),
                                  ...
                                  Container(
                                    width: 60,
                                      child: Column(
                                        ...
                                        mainAxisAlignment: MainAxisAlignment.center,
                                        children: [
                                          CustomText(fontSize: font13header, fontWeight: FontWeight.w600, text: "Gross Salary", letterSpacing: 0.5),
                                          CustomText(fontSize: font12, fontWeight: FontWeight.w600, text: "${value.ThisMonthJoinEmployeeList[index]["GROSS"]}", letterSpacing: 0.5),
                                        ],
                                      )
                                  ),
