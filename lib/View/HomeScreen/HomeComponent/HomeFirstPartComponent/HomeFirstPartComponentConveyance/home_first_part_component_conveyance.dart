...
class HomeFirstPartComponentConveyance extends StatefulWidget {
  ...
  @override
  State<HomeFirstPartComponentConveyance> createState() =>
      _HomeFirstPartComponentConveyanceState();
}

class _HomeFirstPartComponentConveyanceState
    extends State<HomeFirstPartComponentConveyance> {
  int selectedindex = 0;
                                                    ...
                                                    child: SingleChildScrollView(
                                                        child: CustomText(
                                                            ...
                                                            fontWeight:
                                                                FontWeight.w400,
                                                            text:
                                                                " dfsidu fsdfh something gfusdygf usd djfhsd fsd fsd fhsdkfhskdh ahifhsdi fisd sdh f shdif hiscxvvxcv xcv xc cx vcx xcv xcv cxhdfishdif sdh fihdsi sid fisdhif sid fisdh fgusd gf ugsd  ufg sudgfu sdgfusgdfugsudgf",
                                                            letterSpacing:
                                                                0.2))),
                                                SizedBox(
                                                  height: 10,
