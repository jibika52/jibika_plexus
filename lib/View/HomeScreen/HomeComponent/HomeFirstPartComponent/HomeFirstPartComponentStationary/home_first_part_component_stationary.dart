...
class HomeFirstPartComponentStationary extends StatefulWidget {
  ...
  @override
  State<HomeFirstPartComponentStationary> createState() => _HomeFirstPartComponentStationaryState();
}

class _HomeFirstPartComponentStationaryState extends State<HomeFirstPartComponentStationary> {
  int  selectedindex=0;
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Column(
                                                      crossAxisAlignment: CrossAxisAlignment.start,
                                                      children: [
                                                        CustomText(fontSize:font12, fontWeight: FontWeight.w400, text: "Remarks: ", letterSpacing: 0.3),
                                                        SizedBox(height: 5,),
                                                        Expanded(
                                                          child: Container(
                                                            height: 30,
                                                            ...
                                                            child: CustomText(maxLines: 1,overflow: TextOverflow.ellipsis,fontSize: 12, fontWeight: FontWeight.w400, text: "I am Uzzal Kumar Biswas", letterSpacing: 0.3),
                                                          ),
                                                        )
                                                      ],
                                                    ),
