...
class HomeFirstPartComponentLoan extends StatefulWidget {
  ...
  @override
  State<HomeFirstPartComponentLoan> createState() =>
      _HomeFirstPartComponentLoanState();
}

class _HomeFirstPartComponentLoanState
    extends State<HomeFirstPartComponentLoan> {
  int selectedindex = 0;
