...
class HomeFirstPartComponentPromotionScreen extends StatefulWidget {
  ...
  @override
  State<HomeFirstPartComponentPromotionScreen> createState() =>
      _HomeFirstPartComponentPromotionScreenState();
}

class _HomeFirstPartComponentPromotionScreenState
    extends State<HomeFirstPartComponentPromotionScreen> {
  int selectedindex = 0;
                                                          ...
                                                          CustomText(
                                                              ...
                                                              fontWeight:
                                                                  FontWeight
                                                                      .w400,
                                                              text:
                                                                  "Desig : Jr. software Ebngineerjdhfbjsdjzc ",
                                                              letterSpacing:
                                                                  0.2),
                                                        ],
                                                      ),
