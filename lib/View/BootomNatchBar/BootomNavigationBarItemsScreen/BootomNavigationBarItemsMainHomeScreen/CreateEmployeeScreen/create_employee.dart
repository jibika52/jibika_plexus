                ...
                child: InkWell(
                    onTap: () {
                      Navigator.push(
                          context,
                          CupertinoPageRoute(
                            builder: (context) => CreateNewEmployeeScreen2(
                              ...
                              siftplaneController: "104",
                              StafCategoryController: "1842403",
                              religion: "1755116",
                              department_id: "1842397",
                              designation_id: "6245",
                              section_id: "1842411",
                              workstation_id: "1755094",
                              rostertype_id: "1755267",
                              rostergroup_id: "1842263",
                            ),
                          ));
                    },
                    child: ColorCustomText(
                ...
                onTap: () {
                  if (_nIDController.text.isEmpty) {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        ...
                        content: Text("Ennter NID ")));
                  } else {
                    if (_employeeIdController.text.isEmpty) {
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          duration: Duration(milliseconds: 500),
                          content: Text("Ennter Employee ID ")));
                    } else {
                      if (_employeeNameController.text.isEmpty) {
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            duration: Duration(milliseconds: 500),
                            content: Text("Ennter Employee Name")));
                      } else {
                        if (_birthDateController.text.isEmpty) {
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                              duration: Duration(milliseconds: 500),
                              content: Text("Ennter Employee BirthDate")));
                        } else {
                          if (_growsSalaryController.text.isEmpty) {
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                duration: Duration(milliseconds: 500),
                                content: Text("Ennter Grows Salary")));
                          } else {
                            if (_joiningDateController.text.isEmpty) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                      duration: Duration(milliseconds: 500),
                                      content: Text("Ennter Joinning Date")));
                            } else {
                              if (shiftplan_id == "") {
                                ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                        duration: Duration(milliseconds: 500),
                                        content: Text("Select Shift plane")));
                              } else {
                                if (m == false && o == false && f == false) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                          duration: Duration(milliseconds: 500),
                                          content: Text("Select Genger")));
                                } else {
