...
class CreateNewEmployeeScreen2 extends StatefulWidget {
  ...
  @override
  State<CreateNewEmployeeScreen2> createState() =>
      _CreateNewEmployeeScreen2State();
}
...
class _CreateNewEmployeeScreen2State extends State<CreateNewEmployeeScreen2> {
  ...
  TextEditingController _RelationwithNomineeController =
  ...
  Future<String?> _extractText(File file) async {
    ...
    String text = recognizedText.text
        .substring(82, recognizedText.text.length)
        .replaceAll(":", "")
        .replaceAll("Nam", "")
        .replaceAll("ID", "")
        .replaceAll("NID", "");
    print(
        "cccccccccccccccccccc------------------ ${text}-----------------------------");
    textRecognizer.close();
    _NID == null
        ? _employeeNameController
        : _employeeNameController.text =
            "${text.split('Date of Birth')[0] ?? ""}";
    _NID == null
        ? _birthDateController
        : _birthDateController.text =
            "${text.split('Date of Birth')[1].split('N')[0] ?? ""}";
    _NID == null
        ? _nIDController
        : _nIDController.text =
            "${text.split('Date of Birth')[1].split('NO')[1] ?? ""}";
    return text;
  }
  ...
  void initState() {
    Provider.of<OnboardingEmployeeController>(context, listen: false)
        .GetDepartmentNDesinationListProvider(
    ...
    _joiningDateController.text = "${widget.employeeJoiningDate}" == "null"
        ? ""
        : widget.employeeJoiningDate;
  ...
  Widget build(BuildContext context) {
    print(
        "cccccccccccccccccccccccccccccccccccc ${widget.employeeNID}  ${widget.employeeJoiningDate}");
    List shiftplanelist = Provider.of<OnboardingEmployeeController>(context)
        .GetShiftPlanNWeekendList["shiftplan"];
    List religionlist = Provider.of<OnboardingEmployeeController>(context)
        .GetShiftPlanNWeekendList["religion"];

    List departments = Provider.of<OnboardingEmployeeController>(context)
        .GetDepartmentNDesinationList["departments"];

    List designations = Provider.of<OnboardingEmployeeController>(context)
        .GetDepartmentNDesinationList["designations"];
    List section = Provider.of<OnboardingEmployeeController>(context)
        .GetDepartmentNDesinationList["section"];
    List workstation = Provider.of<OnboardingEmployeeController>(context)
        .GetDepartmentNDesinationList["workstation"];
    List rostertype = Provider.of<OnboardingEmployeeController>(context)
        .GetDepartmentNDesinationList["rostertype"];
    List rostergroup = Provider.of<OnboardingEmployeeController>(context)
        .GetDepartmentNDesinationList["rostergroup"];
    List staffCategory = Provider.of<OnboardingEmployeeController>(context)
        .GetDepartmentNDesinationList["staffcategory"];
    double h = MediaQuery.of(context).size.height;
    double w = MediaQuery.of(context).size.width;
    double C_height = 8;
    double Cwidth = 10;
    print(
        "cccccccccccccccccccc ${religionlist} cccccccccccccccc ${widget.employeeNID}  ${widget.employeeJoiningDate}");
    return Scaffold(
                                                  ...
                                                  ClipRRect(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: CustomImageSction(
                                                          ...
                                                          radius: 1,
                                                          image:
                                                              "Assets/DashBoardIcons/person1.png"),
                                                    ),
                                                  ),
                                                  Positioned(
                                                    bottom: -1.5,
                                                ...
                                                Container(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: CustomImageSction2(
                                                      ...
                                                      radius: 1,
                                                      image:
                                                          "Assets/DashBoardIcons/empoloyee_card.png",
                                                      img_color:
                                                          Main_Theme_textColor
                                                              .withOpacity(0.7),
                                                    ),
                            ...
                            child: Column(
                              children: [
                                JibikaCustomTextFromField(
                                    ...
                                    height: 50,
                                    img:
                                        "Assets/PrimaryInformation/people (2).png",
                                ...
                                JibikaCustomTextFromField(
                                    ...
                                    height: 50,
                                    img:
                                        "Assets/PrimaryInformation/people (1).png",
                                ...
                                JibikaCustomTextFromField(
                                    ...
                                    height: 50,
                                    img:
                                        "Assets/DashBoardIcons/personalcard.png",
                                ...
                                JibikaCustomTextFromField2(
                                    ...
                                    height: 50,
                                    img:
                                        "Assets/DashBoardIcons/messagetext.png",
                                ...
                                JibikaCustomTextFromField(
                                    ...
                                    height: 50,
                                    img:
                                        "Assets/PrimaryInformation/calendar.png",
                                          ...
                                          child: Container(
                                            ...
                                            child: signature != null
                                                ...
                                                : Column(
                                                    ...
                                                    children: [
                                                      Image.asset(
                                                        "Assets/PrimaryInformation/email.png",
                                                        height: 31,
                                                        width: 45,
                                                        fit: BoxFit.fill,
                                                      ),
                          ...
                          Container(
                            ...
                            child: InkWell(
                              ...
                              child: CustomImageButton(
                                  height: 45,
                                  img: "Assets/PrimaryInformation/save 1.png",
                                  text: "Save",
                                  textColor: Colors.white,
                                  b_color: CustomButtonColor),
                            ),
                          ),
                          SizedBox(
                            height: C_height + 20,
                              ...
                              InkWell(
                                ...
                                child: Padding(
                                  ...
                                  child: CustomImageButton(
                                      height: 45,
                                      img:
                                          "Assets/PrimaryInformation/save 1.png",
                                      text: "Save",
                                      textColor: Colors.white,
                                      b_color: CustomButtonColor),
                                ),
                                    ...
                                    child: Column(
                                      children: [
                                        JibikaCustomTextFromField(
                                            ...
                                            height: 50,
                                            img:
                                                "Assets/PrimaryInformation/money_payment.png",
                                        ...
                                        JibikaCustomTextFromField(
                                            ...
                                            height: 50,
                                            img:
                                                "Assets/PrimaryInformation/home-svgrepo-com 1.png",
                                            hinttext: "House rent",
                                            keyboardType: TextInputType.text,
                                            obscureText: false),
                                        SizedBox(
                                        ...
                                        JibikaCustomTextFromField(
                                            ...
                                            height: 50,
                                            img:
                                                "Assets/PrimaryInformation/people.png",
                                        ...
                                        JibikaCustomTextFromField(
                                            ...
                                            height: 50,
                                            img:
                                                "Assets/PrimaryInformation/gender-7 1.png",
                                        ...
                                        JibikaCustomTextFromField2(
                                            controller:
                                                _ConvinceAllowanceController,
                                            height: 50,
                                            img:
                                                "Assets/PrimaryInformation/convienceallowence.png",
                                        ...
                                        JibikaCustomTextFromField2(
                                            ...
                                            height: 50,
                                            img:
                                                "Assets/PrimaryInformation/other_allowence.png",
                                        ...
                                        JibikaCustomTextFromField2(
                                            controller:
                                                _OtherDeductionController,
                                            height: 50,
                                            img:
                                                "Assets/PrimaryInformation/other_deduction.png",
                                        ...
                                        JibikaCustomTextFromField2(
                                            ...
                                            height: 50,
                                            img:
                                                "Assets/PrimaryInformation/clock.png",
                                        ...
                                        JibikaCustomTextFromField2(
                                            ...
                                            height: 50,
                                            img:
                                                "Assets/PrimaryInformation/bank.png",
                                    ...
                                    child: Column(
                                      children: [
                                                                  ...
                                                                  decoration: BoxDecoration(
                                                                      borderRadius:
                                                                          BorderRadius.circular(
                                                                              50),
                                                                      image: DecorationImage(
                                                                          image: FileImage(_image!.renameSync(_image!
                                                                              .path)),
                                                                          fit: BoxFit
                                                                              .fill)),
                                                                ),
                                        ...
                                        JibikaCustomTextFromField2(
                                            ...
                                            height: 50,
                                            img:
                                                "Assets/PrimaryInformation/phone.png",
                                            hinttext: "Mobile number",
                                            keyboardType: TextInputType.text,
                                            obscureText: false),
                                        SizedBox(
                                        ...
                                        JibikaCustomTextFromField(
                                            ...
                                            height: 50,
                                            img:
                                                "Assets/PrimaryInformation/sms.png",
                                        ...
                                        JibikaCustomTextFromField2(
                                            ...
                                            height: 50,
                                            img:
                                                "Assets/PrimaryInformation/relation.png",
  ...
  functionval() async {
    var nid_cardd = await http.MultipartFile.fromPath(
        'EmpImageFile', "${_image!.path.toString()}");
  ...
  var request = http.MultipartRequest(
      "POST", Uri.parse("${BASEURL}/${EmployeeOnBoarding}"));
  ...
  SaveOnBoarding() async {
    try {
      ...
      request.fields["PERMANENT_ADDRESS_ENGLISH"] =
          _parmenentAddressController.text;
      request.fields["PRESENT_ADDRESS_ENGLISH"] =
      ...
      request.fields["WEEKEND2"] =
          Containsvalue.length >= 2 ? "${Containsvalue[1]}" : "";
      ...
      request.fields["CLIENTBASE_URL"] =
          "${GetStorage().read("APPS_IMG_BASEURL")}";
      request.fields["Empcode"] = _employeeCodeIdController.text;
      "${_image}" == "null" ? dun() : functionval();
      var response = await request.send();
      print(
          "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa=============================> ${response.stream}");
      var responseData = await response.stream.toBytes();
      print(
          "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb=============================> ${responseData}");
      var responseString = String.fromCharCodes(responseData);
      print(
          "ccccccccccccccccccccccccccccccccccccccccccc=============================> ${responseData}");
      var data = jsonDecode(responseString);
      print(
          "dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd${data}");
      if (data["msg"] == "success") {
        ElegantNotification(
