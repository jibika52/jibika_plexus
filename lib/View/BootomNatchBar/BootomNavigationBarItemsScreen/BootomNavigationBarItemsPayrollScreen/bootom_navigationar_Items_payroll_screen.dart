   ...
   //   appBar: PreferredSize(preferredSize: Size.fromHeight(75), child: CustomDefaultAppBar(onTap: () => Navigator.pop(context), text: "Attendance Calendar ")),
      body:  Stack(
              ...
              children: [
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(borderRadius: BorderRadius.circular(7),border: Border.all(color: Main_Theme_textColor.withOpacity(0.3))),
                                child: Row(
                ...
                Expanded(
                    child: Consumer<HomeProvider>(
                      ...
                      value.dashboardSalaryComparisanChartList==null?Center(child: CircularProgressIndicator(backgroundColor: CustomButtonColor,),) :
                      Container(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount:  value.dashboardSalaryComparisanChartList.length,
                            ...
                            child: Row(
                              children: [
                               Container(
                                 ...
                                 child: Column(
                                   children: [
                                     ColorCustomText(fontSize: 14, fontWeight: FontWeight.w500, text: "${value.dashboardSalaryComparisanChartList[index]["PayrollMonth"].split("-").elementAt(0)}", letterSpacing: 0.2, textColor: presentsent_color),
                                     ColorCustomText(fontSize: 12, fontWeight: FontWeight.w400, text: "${DateTime.now().year}", letterSpacing: 0.2, textColor: Main_Theme_textColor),
                                   ],
                                 ),
                               ),
                                Column(
                                  ...
                                  children: [
                                    ColorCustomText(fontSize: 14, fontWeight: FontWeight.w500, text: "${value.dashboardSalaryComparisanChartList[index]["TotalEmp"]}", letterSpacing: 0.2, textColor: Main_Theme_textColor),
                                ...
                                Column(
                                  ...
                                  children: [
                                    ColorCustomText(fontSize: 14, fontWeight: FontWeight.w500, text: "${value.dashboardSalaryComparisanChartList[index]["TotalNetPay"]}", letterSpacing: 0.2, textColor: Main_Theme_textColor),
        ...
        Positioned(
          ...
          bottom: 15,
          child: InkWell(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => PAyrollProcessScreen(),)),
            child: CircleAvatar(
            radius: 25,
            backgroundColor: CustomButtonColor,
              child: Icon(Icons.add,size: 25,color: Main_Theme_WhiteCollor.withOpacity(0.95),),
                    ),
          ),)
        ],
      ),
