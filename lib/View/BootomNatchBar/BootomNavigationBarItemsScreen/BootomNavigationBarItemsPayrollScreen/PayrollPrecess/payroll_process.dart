                    ...
                    child: Row(
                      children: [
                        Column(
                          ...
                          children: [
                            ColorCustomText(fontSize: 14, fontWeight: FontWeight.w400, text: "From", letterSpacing: 0.2, textColor: Main_Theme_textColor),
                            Container(
                              height: 28,
                              decoration: BoxDecoration(
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ColorCustomText(fontSize: 14, fontWeight: FontWeight.w400, text: "To", letterSpacing: 0.2, textColor: Main_Theme_textColor),
                            Container(
                              height: 28,
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(4),
