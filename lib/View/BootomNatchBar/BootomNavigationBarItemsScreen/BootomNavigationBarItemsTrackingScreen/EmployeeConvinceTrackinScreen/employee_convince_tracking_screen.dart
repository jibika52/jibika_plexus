...
class EmployeeConvinceTrackinScreen extends StatefulWidget {
  ...
  @override
  State<EmployeeConvinceTrackinScreen> createState() =>
      _EmployeeConvinceTrackinScreenState();
}

class _EmployeeConvinceTrackinScreenState
    extends State<EmployeeConvinceTrackinScreen> {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
          ...
          child: CustomDefaultAppBar(
              onTap: () => Navigator.pop(context), text: "Convince")),
      body: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      color:
                          Main_Theme_textColor_tir_Condition.withOpacity(0.1),
                      child: Row(
