...
class BootomNavigationBarItemsTrackingScreen extends StatefulWidget {
  ...
  @override
  State<BootomNavigationBarItemsTrackingScreen> createState() =>
      _BootomNavigationBarItemsTrackingScreenState();
}

class _BootomNavigationBarItemsTrackingScreenState
    extends State<BootomNavigationBarItemsTrackingScreen> {
  int selectedindex = 0;
  ...
  void initState() {
    Provider.of<TrackingController>(context, listen: false)
        .GetMovementTrackableEmployeeListProvider(
            "${GetStorage().read("mobile_id")}", "Y", context);
              ...
              child: Container(
                ...
                child: Consumer<TrackingController>(
                  builder: (context, value, child) => value
                              .GetMovementTrackableEmployeeList ==
                          null
                      ? Center(
                      ...
                      : ListView.builder(
                          itemCount:
                              value.GetMovementTrackableEmployeeList.length,
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                              ...
                                              Padding(
                                                ...
                                                child: ClipRRect(
                                                    ...
                                                    child: CustomImageSction(
                                                        ...
                                                        radius: 1,
                                                        image:
                                                            "Assets/DrawerImage/trackingimage.png")),
                                              ),
                                              Positioned(
                                                  left: 4.0,
                                                  top: 1.6,
                                                    ...
                                                    child: Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                          ...
                                                          image: DecorationImage(
                                                              image: NetworkImage(
                                                                  "${GetStorage().read("APPS_IMG_BASEURL")}/${value.GetMovementTrackableEmployeeList[index]["EMP_PHOTO_PATH"]}"),
                                                              fit:
                                                                  BoxFit.fill)),
                                                    ),
                                                  ))
                                        ...
                                        Expanded(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                "${value.GetMovementTrackableEmployeeList[index]["EMPLOYEE_NAME"]}",
                                              ...
                                              CustomText(
                                                ...
                                                text:
                                                    "${value.GetMovementTrackableEmployeeList[index]["DESIG_NAME"]}",
                                                letterSpacing: 0.3,
                                              ),
                                            ],
                                          ),
                                        ...
                                        CustomTrackNowButton(
                                          b_text: "Track history",
                                          onTap: () {
                                            Navigator.push(
                                                context,
                                                MaterialPageRoute(
                                                  builder: (context) =>
                                                      EmployeeTrackinScreen(
                                                    image:
                                                        "${value.GetMovementTrackableEmployeeList[index]["EMP_PHOTO_PATH"]}",
                                                    name:
                                                        "${value.GetMovementTrackableEmployeeList[index]["EMPLOYEE_NAME"]}",
                                                    e_code:
                                                        "${value.GetMovementTrackableEmployeeList[index]["EMPCODE"]}",
                                                    e_deg:
                                                        "${value.GetMovementTrackableEmployeeList[index]["DESIG_NAME"]}",
                                                    e_dep:
                                                        "${value.GetMovementTrackableEmployeeList[index]["DEPT_NAME"]}",
                                                    selectedDate:
                                                        "$selected2Datee",
                                                    ID_CARD_NO:
                                                        "${value.GetMovementTrackableEmployeeList[index]["ID_CARD_NO"]}",
                                                  ),
                                                ));
                                          },
                                        )
