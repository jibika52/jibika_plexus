...
class _EmployeeTrackinScreenState extends State<EmployeeTrackinScreen> {
  ...
  void initState() {
    Provider.of<TrackingController>(context, listen: false)
        .GetMovementTrackableEmployeeByAttendanceDateProvider(
    ...
    Provider.of<TrackingController>(context, listen: false)
        .GetEmployeeLocaltionInfoProvider("${GetStorage().read("mobile_id")}",
            "${selected2Datee}", "${widget.e_code}", context);
          ...
          children: [
            ...
            Stack(
              children: [
                ...
                customMainEmployeeProfile(
                    image: "${widget.image}",
                    employeeCode: "${widget.e_code}",
                    employeeName: "${widget.name}",
                    employeeDesignation: "${widget.e_deg}",
                    employeeDepartment: "${widget.e_dep}",
                    birthday: "",
            ...
            Consumer<TrackingController>(
              builder: (context, value, child) => value
                      ...
                      null
                  ? Center(
                      child: Text("Please wait searchin tracking info"),
                    )
                  : Expanded(
                          ...
                          children: [
                            Consumer<TrackingController>(
                              builder: (context, value, child) => value
                                  ...
                                  : value.GetMovementTrackableEmployeeByAttendanceDatelist[
                                              0]["SHIFT_IN_TIME"] ==
                                          ""
                                      ? Container()
                                      : Container(
                                                    ...
                                                    children: [
                                                      ColorCustomText(
                                                          ...
                                                          text: value.GetMovementTrackableEmployeeByAttendanceDatelist[
                                                                  ...
                                                                  ""
                                                              ? ""
                                                              : "Check In -${value.GetMovementTrackableEmployeeByAttendanceDatelist[0]["ACTUAL_IN_TIME"].toString().substring(12, 20)}",
                                                          letterSpacing: 0.3,
                                                          textColor:
                                                                      ...
                                                                      0.8)),
                                                      {
                                                          ...
                                                          ? Container()
                                                          : Text(
                                                              "${value.GetMovementTrackableEmployeeByAttendanceDatelist[0]["IN_LOCNAME"]}",
                                                              overflow:
                                                                  TextOverflow
                                                                      .ellipsis,
                                                              style: GoogleFonts
                            ...
                            Padding(
                              ...
                              child: ListView.builder(
                                ...
                                shrinkWrap: true,
                                itemCount:
                                    value.EmployeeLocaltionInfoList.length,
                                                    ...
                                                    children: [
                                                      ColorCustomText(
                                                          ...
                                                          fontWeight:
                                                              FontWeight.w400,
                                                          text:
                                                              "Check In -${value.GetMovementTrackableEmployeeByAttendanceDatelist[0]["ACTUAL_OUT_TIME"].toString().substring(12, 20)}",
                                                          letterSpacing: 0.3,
                                                          textColor:
                                                              Main_Theme_textColor
                                                                  .withOpacity(
                                                                      0.8)),
                                                      Text(
                                                        "${value.GetMovementTrackableEmployeeByAttendanceDatelist[0]["OUT_LOCNAME"]}",
