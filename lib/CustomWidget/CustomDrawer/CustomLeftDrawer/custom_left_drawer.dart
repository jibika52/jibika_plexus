            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  CustomDrawerOption(image: "Assets/DrawerImage/drawer_reportbox_option.png", name: "Stationary Manager", size: 19,size2: 16,),
                  CustomDrawerOption(image: "Assets/DrawerImage/drawer_monysend.png", name: "Complaint Box", size: 18,size2: 16,),
                  CustomDrawerOption(image: "Assets/DrawerImage/drawer_reportbox_option.png", name: "Report Manager", size: 18, size2: 16,),
                  CustomDrawerOption(image: "Assets/DrawerImage/drawer_reportbox_option.png", name: "Privacy Policy", size: 16,size2: 16,),
                  CustomDrawerOption(image: "Assets/DrawerImage/drawer_tirmscondition_option.png", name: "Terms & Condition", size: 16,size2: 16,),
                  CustomDrawerOption(image: "Assets/DrawerImage/drawer_disclimer_option.png", name: "Disclaimer", size: 16, size2: 16,),
                  CustomDrawerOption(image: "Assets/DrawerImage/drawer_setting_option.png", name: "Setting", size: 16, size2: 16,),
                  SizedBox(height: 100,)
                ],
              ),
            ),
