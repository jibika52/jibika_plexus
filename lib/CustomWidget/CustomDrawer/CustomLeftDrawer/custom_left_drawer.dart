                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image: AssetImage(
                                          "Assets/SelfIcon/profile_background.jpg"),
                                      fit: BoxFit.fill),
                                  borderRadius: BorderRadius.circular(5)),
                            ),
                            Container(
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: CustomImageSctionNetwork(
                              ...
                              width: 100,
                              radius: 100,
                              image: "${GetStorage().read("APPS_IMG_Path")}"),
                        ),
                      ),
                      // Positioned(
                      //   top: 122/2-5,
                    ...
                    child: Column(
                      children: [
                            ...
                            children: [
                              Container(
                                ...
                                child: ColorCustomText(
                                  ...
                                  text:
                                      " ${GetStorage().read("APPS_User_Name")}",
                                  overflow: TextOverflow.ellipsis,
                                  letterSpacing: 0.5,
                        ...
                        Consumer<CounterProvider>(
                          builder: (context, value, child) => GetStorage()
                                      .read("user_type_id") ==
                                  1003
                              ? Divider()
                              : Container(
                                  ...
                                  child: CustomButton(
                                      onTap: () {
                                        if (value.are_you_user_or_admin ==
                                            "user") {
                                          Navigator.push(
                                              context,
                                              CupertinoPageRoute(
                                                builder: (context) =>
                                                    BootomNatchBarScreen(
                                                  index: 4,
                                                ),
                                              ));
                                        } else {
                                      ...
                                      text:
                                          value.are_you_user_or_admin == "user"
                                              ? "Switch to Admin mode"
                                              : "Switch to Self mode",
                                      button_text_fontSize: fontSubTitle,
                                      button_height: 35,
                        ...
                        CustomDrawerOption(
                          image: "Assets/DrawerImage/drawericonong.png",
                          name: "Home",
                          size: 16,
                          size2: 16,
                        ),
                        CustomDrawerOption(
                          image: "Assets/DrawerImage/leaveupbrla.png",
                          name: "Planning",
                          size: 20,
                          size2: 20,
                        ),
                        CustomDrawerOption(
                          image: "Assets/DrawerImage/drawer_person_option.png",
                        ...
                        CustomDrawerOption(
                          image:
                              "Assets/DrawerImage/drawer_attendence_option.png",
                        ...
                        CustomDrawerOption(
                          image:
                              "Assets/DrawerImage/drawer_employee_option.png",
                        ...
                        CustomDrawerOption(
                          image:
                              "Assets/DrawerImage/drawer_employee_trace_option.png",
                        ...
                        CustomDrawerOption(
                          image:
                              "Assets/DrawerImage/drawer_employee_cash_option.png",
                        ...
                        CustomDrawerOption(
                          image:
                              "Assets/DrawerImage/drawer_reportbox_option.png",
                          name: "Stationary Manager",
                          size: 18,
                          size2: 16,
                        ),
                        CustomDrawerOption(
                          image: "Assets/DrawerImage/drawer_monysend.png",
                          name: "Complaint Box",
                          size: 19,
                          size2: 16,
                        ),
                        ...
                        CustomDrawerOption(
                          image:
                              "Assets/DrawerImage/drawer_tirmscondition_option.png",
                        ...
                        CustomDrawerOption(
                          image:
                              "Assets/DrawerImage/drawer_disclimer_option.png",
                          name: "Disclaimer",
                          size: 16,
                          size2: 16,
                        ),
                        CustomDrawerOption(
                          image: "Assets/DrawerImage/drawer_setting_option.png",
                          name: "Setting",
                          size: 17,
                          size2: 16,
                        ),
                    ...
                    child: Row(
                      ...
                      children: [
                        CustomImageSction(
                            ...
                            radius: 0,
                            image:
                                "Assets/DrawerImage/drawer_logout_option.png"),
                        SizedBox(
                          width: 7,
                        ),
                        ColorCustomText(
