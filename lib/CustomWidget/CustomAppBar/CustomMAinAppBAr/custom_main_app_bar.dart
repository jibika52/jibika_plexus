                    ...
                    Stack(
                      children: [
                        ...
                        Positioned(
                            ...
                            child: CircleAvatar(
                              radius: 7,
                              child: ColorCustomText(fontSize: 9, fontWeight: FontWeight.w700, text:"${socketmessage.setNotificationCounter.toString()}"=="null"?"0" : "${socketmessage.setNotificationCounter.toString()}", letterSpacing: 1, textColor: notification_color),
                            ))
                      ],
                    ),
                  ),
...
class SelfCustomMainAppBar extends StatelessWidget {
  SelfCustomMainAppBar({super.key,
  required this.leading_image_route,
  required this.center_appbar_text,
  required this.leading_ontab,
  required this.is_need_trailing,
